        ...
        <div class="contactez-top auto-padding">
            <div class="row justify-content-center">
                ...
                <div class="col-md-7 col-12 info">
                    ...
                    <?php
                    if (have_rows('form_top')) :
                        while (have_rows('form_top')) : the_row();
                    ?>
                            <p>
        ...
        <div class="container">
            <div class="row justify-content-center flex-md-row flex-column-reverse">
                <div class="col-md-5 col-12 flex-md-row">
                    <div class="form">
                        <?php echo do_shortcode('[contact-form-7 id="0f991d5" title="VousEtesPro"]') ?>
                    </div>
                </div>
                <div class="col-md-5 col-12 d-flex align-items-center">
                    <?php
                    if (have_rows('form_bottom')) :
                        while (have_rows('form_bottom')) : the_row();
                    ?>
                            <div class="content">
